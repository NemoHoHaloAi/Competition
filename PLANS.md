...
- 2020-01-25: 微积分(第九章)、Recruit(在现有scripy基础上优化，观察特征重要性，考虑是否能引入lag型特征)、用数据讲故事(48%)；
- 2020-01-26: 用数据讲故事(60%)、微积分(完成第九章)、Recruit(集合script的FE完成EDA部分，阶段性总结告一段落，整理下competition仓库各种时间点信息等等)、计划下一步；
