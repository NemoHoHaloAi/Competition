...
- 2019-12-22: 技法-02(WTF),03(WTF),04、Store-Item-Demand(修改参数运行，该项目似乎有验证集污染问题，平均特征计算时使用了训练+验证的数据，但是这部分数据理应是不可见的)与手写识别(离线运行，修改验证集划分时机避免数据增强的污染)、Recruit Restaurant Visitor Forecasting(开始，提交初版)；
