...
- 2019-01-08: 微积分(完成第三章)、Recruit(1. 去调log1p动作，方便对比验证结果和测试结果，2.继续分析与valid差异这么大的原因，分析头部特征，去掉dayofyear_avg_visitors和weekofyear_avg_visitors两个明显差异特征，目前结果是0.75，已经不存在bug)、发布Wechat+到cnblog、[HelloGithub](https://hellogithub.com/)；
- 2019-01-09: 微积分(完成第四章)、微积分(完成第五章)、Web Traffic Forecast(启动)、Recruit(目前valid分数过低，对去除部分做恢复，一致的特征恢复回来，比如dayofweek系列)；
