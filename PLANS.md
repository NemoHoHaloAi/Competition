...
- 2020-01-26: Recruit(结合EDA kernel、对script的fe进行分析，重点是EDA对FE的影响，更新下competition仓库各种score、时间点等信息，计划下一步关于项目的安排)、用数据讲故事(80%)、微积分(第九章)；
- 2020-01-27: 用数据讲故事(完成，写一篇总结文章，流水账形式，发布到博客园)、微积分(完成第九章)；
