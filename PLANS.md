...
- 2020-01-12: Recruit(如何分别对visit和reserve进行fe后，进行整合，考虑清楚整合的基本形式)、微积分(完成第五章连续性和可导性)、微积分(完成第六章求解微分问题)；
- 2020-01-13: Recruit(执行最新的想法，链接100米内的预约数据，这个100可以调整，具体要看店铺距离分布)；
- 2020-01-14: Web Traffic Forecast(启动)、Recruit(尝试距离1000，依然有很多店铺在条件内没有合适的预约信息)；
...
- 2020-01-18: 微积分(完成第七章三角函数的极限和导数，开始第八章隐函数求导与相关变化率)、WebTraffic(继续跟进，存在内存过高问题需要优化)；
- 2020-01-19: WebTraffic(内存优化)、微积分(第八章隐函数求导与相关变化率)；
- 2020-01-20: NFL(博客整理发出)；
- 2020-01-21: WebTraffic(提交第一版，目前依然无法提交，内存限制导致字段在做label encode时kernel重启)、微积分(完成第八章隐函数求导与相关变化率)、NFL2(博客整理发出)；
- 2020-01-22: WebTraffic(从其他kernel中学习尝试解决内存限制问题，尽快提交第一版，目前看由于数据或者竞赛方式问题分享基本都是EDA部分，暂停)、微积分(开始第九章指数函数与对数函数)；
- 2020-01-24: Recruit(继续优化，解决预约数据的结合部分为什么没能提升分数，整理了EDA的kernel，一个script的kernel)、微积分(第九章)、用数据讲故事(33%)；
...
- 2020-02-15: 武汉冠状病毒数据上传kaggle、NCAA疯狂三月分析预测项目；
- 2020-02-17~19: 上班，办理交接手续，联系队友；
- 2020-02-21: 队伍基本成型，还有一个同学待定，nacc小分队，工作划分基本完成，今天明天主要开展对往期比赛获取kernel的整理，由我和数字进行；
